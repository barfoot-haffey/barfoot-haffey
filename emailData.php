...
try {
    ...
    //Recipients
    $mail->setFrom('anthony@open-collector.org', 'Mailer');
    ...
    $mail->Subject = "$participant completed with completion code: $completion_code";
    $mail->Body    = "To confirm, the participant info was: <br><br>Participant: $participant  <br>Completion Code: $completion_code <br><br> Go to <b>https://www.open-collector.org/kitten/</b> and click on the <b>Data</b> tab to decrypt this file.";
    $mail->AltBody = "To confirm, the participant info was: <br><br>Participant: $participant  <br>Completion Code: $completion_code <br><br> Go to <b>https://www.open-collector.org/kitten/</b> and click on the <b>Data</b> tab to decrypt this file.";
